...
function Products() {
    ...
    const handleSearchBar=debounce((event) => {
            ...
            <div className="bg-white">
                ...
                <div className="relative mt-2 rounded-md flex items-center gap-8 mb-4">
                    <input
                        ...
                        placeholder="IPhone"
                    />
                    <select className="border p-2" onChange={handleOptions}>
                        <option>Select Option</option>
                        {categories?.map((category) => (
                            <option key={category} value={category} defaultValue="Select Option">
                                {category}
                            </option>
                        ))}
                    </select>
